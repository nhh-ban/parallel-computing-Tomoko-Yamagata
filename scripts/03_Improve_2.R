#Solution file 03
#The solution script where you rewrite the function MTweedieTests to
#split the M simulations in more than one core, 
#and otherwise let the original script remain unchanged.
...
max_cores <- 4  # Change this to the number of cores you want to utilize
...
#Error!!!!!!
#task 1 failed - "could not find function "simTweedieTest2""
